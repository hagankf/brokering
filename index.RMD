...
pw1 %>% 
  ...
  scale_x_discrete(
    name = "",
    labels = function(broker_factor) str_wrap(broker_factor, width = 12)
  ) +
  ylab("Number of parents") +
  #scale_y_continuous(expand=c(0,0)) +
  labs(
    #title = "Parental Report of Adolescent Language Brokering",
